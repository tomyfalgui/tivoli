...
export default () => (
  <section className="p-10 py-20 bg-primary-blue overflow-hidden pb-24">
    <h2 className="tracking-wide font-display font-semibold tracking-wider text-bluish-white text-center mb-8 p">
      Testimonials
    </h2>
    <div className="flex overflow-x-auto">
      <div className="px-4 bg-card-blue py-4 rounded-card border-solid border border-card-border pb-10 mr-4 flex-shrink-0">
        {/* Header */}
        <div className="flex border-border-white border-solid border-b items-start">
          <svg
            width="32"
            height="31"
            className="mr-3"
          ...
          <div className="flex flex-col mb-4">
            <p className="text-sm text-header-white font-bold tracking-wide">
              Name of Company
            </p>
            <p className="text-xs tracking-wider text-subheader-white">
              JOHN ANTHONY SMITH, CEO
            </p>
          </div>
        </div>
        {/* END HEADER */}
        ...
        <div>
          <p className="text-sm font-bold pt-3 text-bluish-white tracking-wide mb-2">
            “It’s the most convenient one ever!”
          </p>
          <p className="text-xs text-bluish-white mb-6 tracking-wide max-w-card">
            ...
            isnisiutaliq uipexeac ommod oconse quat.
          </p>
          <div className="flex items-center ">
            ...
            <p className="text-faded-blue text-sm">5/5 stars</p>
          </div>
        </div>
