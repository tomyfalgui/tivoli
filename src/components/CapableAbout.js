  ...
  <CapableAboutSection>
    ...
    <Card>
      ...
      <p>
        ...
        compromises are made as much as possible and make the after care of our
        crafted products the easier as can be.
      </p>
    </Card>
    <Card>
      <svg
      ...
      <p>
        In every part of the design and development process, we loop our clients
        in to make sure that there is uniqueness and personalization in the
        products we make.
      </p>
    </Card>
    <Card>
